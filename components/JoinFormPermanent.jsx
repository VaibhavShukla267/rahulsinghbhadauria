...
import { User, Phone, MapPin, ShieldCheck, CreditCard, Award, CheckCircle2 } from "lucide-react";
...
export default function FormComponent() {
  ...
  const validateForm = () => {
    ...
    if (Number(donateAmount) < 251) {
      toast.error('न्यूनतम सहयोग राशि ₹251 है');
      return false;
    }
  ...
  const handlePayNow = async () => {
    ...
    try {
      ...
      const options = {
        ...
        description: "Active Membership Payment",
        order_id: orderId,
        handler: async function (response) {
          try {
            ...
            if (data.success) {
              setIsSubmitting(false);
              toast.success("सक्रिय सदस्यता सफलतापूर्वक स्वीकृत हुई!");
              setFormData({
                name: "", lname: "", mob: "", whatno: "", district: "",
                loksabha: "", vidansabha: "", ward: "", address: "", state: ""
              });
              setSelectedDistrict("");
              setSelectedLoksabha("");
              setSelectedVidansabha("");
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-amber-900/10 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#3E0D18] via-[#641526] to-[#3E0D18] text-white p-6 sm:p-8 text-center relative">
            <div className="inline-flex items-center gap-2 bg-amber-500/20 text-amber-200 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-2 border border-amber-400/20">
              ...
              <span>विशेष सदस्यता</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">सक्रिय सदस्य फॉर्म</h1>
            <p className="text-amber-100/80 text-xs sm:text-sm mt-1 max-w-xl mx-auto">
              सामाजिक परिवर्तन, युवा अधिकार एवं जनसेवा अभियानों में अग्रिम भूमिका निभाने के लिए सक्रिय सदस्य के रूप में जुड़ें।
            </p>
          </div>

          <form onSubmit={handleSubmit} className="p-6 sm:p-10 space-y-8">

            {/* Read-Only Info & Amount Input Bar */}
            <div className="bg-amber-50/60 rounded-2xl p-4 sm:p-5 border border-amber-200/60 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <Label className="text-xs font-bold text-amber-900 uppercase tracking-wider">सदस्यता श्रेणी</Label>
              ...
              <div>
                <Label htmlFor="donateAmount" className="text-xs font-bold text-amber-900 uppercase tracking-wider">सहयोग राशि (₹) *</Label>
                <Input
                  id="donateAmount"
                  type="number"
                  min="251"
                  ...
                  className="mt-1 bg-white border-amber-200 focus:border-[#641526] font-bold text-gray-800"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-[#641526] font-bold text-base border-b border-amber-100 pb-2">
                ...
                <span>पता एवं क्षेत्र विवरण</span>
              </div>
            ...
            <div className="bg-amber-50/40 rounded-2xl p-5 border border-amber-200/60 space-y-3">
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="consent" className="text-xs text-gray-700 leading-relaxed cursor-pointer font-serif">
                  मैं एतद्द्वारा सत्यनिष्ठा से घोषणा करता हूँ कि मैं सक्रिय सदस्य के रूप में सामाजिक कल्याण, जनसमस्या समाधान एवं राष्ट्र की प्रगति हेतु सदैव तत्पर रहूँगा।
                </label>
              </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-amber-100">
              <div className="flex items-center gap-2 text-xs font-semibold text-gray-500">
                ...
                <span>100% सुरक्षित भुगतान (Razorpay)</span>
              </div>
              ...
              >
                ...
                <span>{isSubmitting ? "प्रक्रिया जारी है..." : `सक्रिय सदस्य बनें (₹${donateAmount})`}</span>
              </Button>
            </div>
