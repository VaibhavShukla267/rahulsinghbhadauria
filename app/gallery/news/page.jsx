        ...
        <>
            <div className="container mx-auto px-4 py-8">
                <div className="flex items-center flex-col">
                    ...
                    <div className="w-24 h-2.5 bg-primary rounded-full mb-10 relative -top-4"></div>
                </div>
                    ...
                    {loading ? (
                        ...
                        newsItems.map((item, index) => (
                            ...
                            >
                                ...
                                <div className="p-4">
                                    <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-primary truncate">{item.title}</h3>
